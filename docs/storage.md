...
For maintenance operations (flush, sync, destroy, repair, dump/load, compaction, bin object GC),
see the [Maintenance Operations](operations.md) document.
...
When compaction triggers bin object GC (see [Bin Object GC](operations.md#bin-object-gc)),
